...
下面涉及到的`数学公式`和`物理公式`可以参考这两篇[《常用的数学公式》](/articles/math-formulas)和[《常用的物理公式》](/articles/physics-formulas)来理解。

### canvas 里的坐标系

<img src='coordinate_system.png' style='max-width:60%'>
...
<img src='rotation.png' style='max-width:60%'/>
