...
[![sentry_invite_member](/img/sentry_invite_member.png)](/img/sentry_invite_member.png)
...
[![sentry_email_setting](/img/sentry_email_setting.png)](/img/sentry_email_setting.png)


这里设置只要有异常事件就发送邮件通知，并把邮件发送人设置为 sentry 团队里的所有成员。

[![sentry_email_error](/img/sentry_email_error.png)](/img/sentry_email_error.png)
